...
STRINGS: dict[str, tuple[str, str, str]] = {
    ...
    "search.hint": (
        "Searches album names, filenames, tags, cameras and lenses. Narrow it with the filters beside the results, or type camera:, lens:, iso:, f:, mm:, date:, tag:, album: or color: — for example color:blue date:2026-08.",
        "Durchsucht Albumnamen, Dateinamen, Tags, Kameras und Objektive. Eingrenzen mit den Filtern neben den Ergebnissen oder mit camera:, lens:, iso:, f:, mm:, date:, tag:, album: oder farbe: — zum Beispiel farbe:blau date:2026-08.",
        "アルバム名・ファイル名・タグ・カメラ・レンズを検索します。結果の横のフィルター、または camera: lens: iso: f: mm: date: tag: album: color: で絞り込めます（例：color:青 date:2026-08）。",
    ),
    ...
    "color.yellow": ("Yellow", "Gelb", "黄"),
    "color.green": ("Green", "Grün", "緑"),
    "color.teal": ("Teal", "Türkis", "青緑"),
    "color.blue": ("Blue", "Blau", "青"),
    "color.purple": ("Purple", "Lila", "紫"),
    "color.pink": ("Pink", "Rosa", "ピンク"),
    "color.brown": ("Brown", "Braun", "茶"),
    "color.black": ("Black", "Schwarz", "黒"),
    "color.grey": ("Grey", "Grau", "灰"),
    "color.white": ("White", "Weiß", "白"),
    "photo.palette": ("Colours", "Farben", "色"),
    "photo.palette_find": ("More photos in {c}", "Mehr Fotos in {c}", "{c}の写真をもっと見る"),
