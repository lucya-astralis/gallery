...
| `tag`       | —           | Photo tag                                                           |
| `q`         | —           | Search: words match album path, filename, tag, camera and lens; `camera:` `lens:` `iso:` `f:` `mm:` `date:` filters narrow — the `/search` grammar |
